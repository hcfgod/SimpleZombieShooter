...
public class WeaponClippingHandler : MonoBehaviour
{
	...
	[SerializeField] private Vector3 cameraTranformOffset;
	...
	private void HandleWeaponClipping()
	{
		...
		if (Physics.SphereCast(new Vector3(cameraTransform.position.x + cameraTranformOffset.x, cameraTransform.position.y + cameraTranformOffset.y, cameraTransform.position.z + cameraTranformOffset.z), sphereRadius, cameraTransform.forward, out hit, weaponLength, environmentLayerMask))
		{
