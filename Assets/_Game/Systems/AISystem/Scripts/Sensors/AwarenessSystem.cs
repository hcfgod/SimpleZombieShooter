...
public class AwarenessSystem : MonoBehaviour
{
    ...
    public virtual void ReportCanSee(DetectableTarget seen)
    {
    ...
    public virtual void ReportCanHear(GameObject source, Vector3 location, EHeardSoundCategory category, float intensity)
    {
    ...
    public virtual void ReportInProximity(DetectableTarget target)
    {
